...
export const stackGroups: StackGroup[] = [
  ...
  { name: { fr: "Architecture & qualité", en: "Architecture & quality" }, items: ["Docker", "Microservices", "RabbitMQ", "Prometheus / Grafana", "TDD", "Jest", "JUnit", "GitHub Actions", "Vercel"] },
...
export const usedIn: Record<string, { fr: string; en: string }> = {
  ...
  "Python": { fr: "CanTelcoX · labos LOG430 (FastAPI)", en: "CanTelcoX · LOG430 labs (FastAPI)" },
